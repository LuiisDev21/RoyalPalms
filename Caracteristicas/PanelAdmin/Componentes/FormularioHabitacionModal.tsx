    ...
    >
      <div className="max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-xl bg-white p-6 shadow-xl">
        ...
        <form onSubmit={Enviar} className="mt-6 flex flex-col gap-4">
          ...
          <div>
            <label htmlFor="habitacion-descripcion" className="block text-sm font-medium text-[#5b564d]">
              Descripción
            </label>
            <textarea
          ...
          <div>
            <label className="block text-sm font-medium text-[#5b564d]">Imagen</label>
            <input
              ref={inputArchivoRef}
              type="file"
