...
const HABITACIONES_DATA = [
  { id: 1, titulo: "Habitación Standard", precio: 80, maxHuespedes: 2, descripcion: "Ideal para viajeros de paso.", imagen: "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b", equipamiento: ["Wifi", "Escritorio"] },
  { id: 2, titulo: "Habitación Superior / Deluxe", precio: 150, maxHuespedes: 2, descripcion: "Mejor experiencia y comodidad.", imagen: "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b", equipamiento: ["Cama King", "Tina"] },
  { id: 3, titulo: "Executive Suite", precio: 380, maxHuespedes: 3, descripcion: "Para el viajero de negocios.", imagen:"https://images.unsplash.com/photo-1566665797739-1674de7a421a"
, equipamiento: ["Nespresso", "Workstation"] },
...
export default function CatalogoPage() {
  ...
  // --- LÓGICA DE FECHAS (Check-In / Check-Out) ---
  useEffect(() => {
    if (fechaEntrada && fechaSalida) {
      ...
      setNoches(dias > 0 ? dias : 1);
    }
  }, [fechaEntrada, fechaSalida]);

  // --- VALIDACIÓN DE HUÉSPEDES POR HABITACIÓN ---
  useEffect(() => {
    if (huespedes > seleccionada.maxHuespedes) {
      setHuespedes(seleccionada.maxHuespedes);
    }
  }, [seleccionada]);

  // Precio final: (Precio Base * Personas) * Noches
  const totalEstimado = (seleccionada.precio * huespedes) * noches;
  ...
  return (
    <main className="min-h-screen bg-[#f8f9fa]">
      ...
      <div className="max-w-[1400px] mx-auto px-6 pt-32 pb-20">
        ...
        {/* PANEL DE FILTROS - DISEÑO DORADO */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-end">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center border-2 border-[#b88f3a]/30 rounded-xl overflow-hidden bg-white">
                ...
                <input type="number" value={huespedes} readOnly className="w-full text-center text-sm font-bold text-black outline-none" />
                <button onClick={() => huespedes < seleccionada.maxHuespedes && setHuespedes(huespedes + 1)} className="px-4 py-2 hover:bg-[#b88f3a] hover:text-white transition-colors text-black font-bold border-l border-[#b88f3a]/10">+</button>
              </div>
            </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          {/* ASIDE DE COTIZACIÓN CON LOGO Y DORADOS */}
          <aside className="w-full lg:w-[400px]">
            <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 p-8 sticky top-32 overflow-hidden">
              ...
              <div className="relative z-10">
                {/* Logo y Nombre con Logo.svg */}
                <div className="flex flex-col items-center gap-3 mb-8 pb-6 border-b border-gray-100">
                  <img src="/Logo.svg" alt="Royal Palm Logo" className="w-16 h-16 drop-shadow-sm" />
                  <div className="text-center">
                     <span className="font-bold text-[#b88f3a] tracking-tighter text-2xl font-serif">Royal Palm</span>
                    <p className="text-[10px] font-bold text-gray-400 uppercase tracking-[4px] mb-1">Resumen de Cotizacion</p>
                ...
                <div className="space-y-6 text-sm mb-10">
                  ...
                  <div className="flex justify-between items-center py-2 border-b border-dashed border-[#b88f3a]/30">
                    ...
                    <span className="font-bold text-[#b88f3a]">{huespedes} personas</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-dashed border-[#b88f3a]/30">
                    <span className="text-gray-500 font-medium italic">Noches totales:</span>
                    <span className="font-bold text-[#b88f3a]">{noches}</span>
                  </div>
                </div>
