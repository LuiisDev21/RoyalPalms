...
export function SidebarPanel({
  ...
  return (
    ...
    >
      <div className="group relative border-b border-[#3d3a35] px-3 py-4">
        <div className={`flex items-center ${Colapsado ? "justify-center" : "justify-between gap-2"}`}>
          ...
          >
            ...
            {!Colapsado && <span className="FuenteTitulo text-lg font-semibold text-white">Royal Palm</span>}
          </Link>
          {!Colapsado && (
            <button
              type="button"
      ...
      <nav className="flex flex-1 flex-col gap-1 overflow-y-auto p-4" aria-label="Panel de administración">
        {PuedeHabitaciones && (
          <EnlaceSidebar
